...
try:
	...
	CREATEPRODUCTPARAMS = {'name': 'cookies', 'price': 1.00, 'category': 'dairy'}
	r_create_product = requests.post(url=URLPRODUCTCREATE, data=CREATEPRODUCTPARAMS, headers={
		'Authorization': 'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJ1c2VybmFtZSI6ICJqbW0ifQ==.02838fbb9275f0c5f5f9b734d984d683be04491cd3a8cf506016c4903bbe8b4f'})
	create_product_data = r_create_product.json()

	ORDERPARAMS = {'order': json.dumps([{'product': 'milk', 'quantity': 3}, {'product': "cookies", 'quantity': 1}])}
